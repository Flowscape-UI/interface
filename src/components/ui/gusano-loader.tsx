...
interface GusanoLoaderProps extends HTMLAttributes<HTMLDivElement> {
  ...
  color?: string;
  /**
   * Whether to enable color animation
   * @default true
   */
  animateColor?: boolean;
  /**
   * Custom colors for animation (only used when animateColor is true)
   * @default ['#9b59b6', '#2980b9', '#c0392b', '#16a085', '#f39c12', '#27ae60', '#419fdd', '#f1c40f', '#1abc9c']
   */
  colors?: string[];
}

/**
 * A unique loading animation with boxes that move in a worm-like pattern.
 */
