...
export function UsageSection({ description, code, className, title = 'Usage' }: UsageSectionProps) {
    ...
    return (
        <section className={cn('mt-20 scroll-m-14', className)}>
            ...
            {/* Code snippet */}
            <Card className="no-scrollbar relative mx-auto mt-9 max-h-[500px] w-full max-w-[738px] overflow-y-auto [&::-webkit-scrollbar]:z-[9999] [&::-webkit-scrollbar-thumb]:z-[9999]">
