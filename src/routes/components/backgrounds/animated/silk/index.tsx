            ...
            <div className="w-full px-6 py-16">
                ...
                <div className="mt-8 flex flex-col gap-10">
                    <PreviewTabs
                        ...
                        reactBitsUrl="https://www.reactbits.dev/backgrounds/silk"
                    >
                ...
                <UsageSection
                    description={t(
                        'This component creates an animated silk background using a custom shader. It is highly configurable through props.',
                    )}
                    code={silkComponentCode}
                />

                <DocsSection
                    description={
                        <p>
                            {t('The effect is achieved using a GLSL shader within a')} React Three
                            Fiber canvas.{' '}
                            {t('All properties are passed as uniforms to the shader.')}
                        </p>
                    }
                    rows={rows}
                />
...
const silkComponentCode = `import React, { forwardRef, useMemo, useRef, useLayoutEffect } from 'react';
import { Canvas, useFrame, useThree, type RootState } from '@react-three/fiber';
import { Color, Mesh, ShaderMaterial, type IUniform } from 'three';
...
export const SilkPlane = forwardRef<Mesh, SilkPlaneProps>(function SilkPlane({ uniforms }, ref) {
    const { viewport } = useThree();
