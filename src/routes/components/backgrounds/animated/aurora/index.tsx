            ...
            <div className="w-full px-6 py-16">
                ...
                <div className="mt-8 flex flex-col gap-10">
                    <PreviewTabs
                        ...
                        reactBitsUrl="https://www.reactbits.dev/backgrounds/aurora"
                    >
                ...
                <UsageSection
                    description={t(
                        'This component uses OGL to render a WebGL canvas with an aurora-like shader animation.',
                    )}
                    code={auroraComponentCode}
                />
