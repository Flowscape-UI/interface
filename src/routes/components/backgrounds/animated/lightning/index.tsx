            ...
            <div className="w-full px-6 py-16">
                ...
                <div className="mt-8 flex flex-col gap-10">
                    <PreviewTabs
                        ...
                        reactBitsUrl="https://www.reactbits.dev/backgrounds/lightning"
                    >
                ...
                <UsageSection
                    description={t(
                        'This component uses a WebGL shader to render a procedural lightning animation.',
                    )}
                    code={lightningComponentCode}
                />
