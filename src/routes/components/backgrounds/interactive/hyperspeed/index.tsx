            ...
            <div className="w-full px-6 py-16">
                ...
                <div className="mt-8 flex flex-col gap-10">
                    <PreviewTabs
                        ...
                        reactBitsUrl="https://www.reactbits.dev/backgrounds/hyperspeed"
                    >
                        <div className="absolute h-full w-full overflow-hidden rounded-lg bg-black">
                            <Hyperspeed />
                        </div>
                    </PreviewTabs>
