    ...
    return (
        ...
        <div className="px-6 py-16 w-full">
            ...
            <div className="mt-8 flex flex-col gap-10">
                <PreviewTabs title="Default" codeText={ballpitCode}>
                    <Ballpit title="Balls." titleClassName="text-[#261e36]" className="h-full w-full" />
                </PreviewTabs>

                <PreviewTabs title="More balls, less gravity" codeText={ballpitCode}>
                     <Ballpit
                        count={400}
                        gravity={0.2}
                        friction={0.9}
                ...
                <PreviewTabs title="No cursor follow, custom colors" codeText={ballpitCode}>
                    <Ballpit
                        followCursor={false}
...
const rows: PropsTableRow[] = [
    ...
    { prop: "title", type: "string", required: false, defaultValue: '""', description: "Title text to display over the animation." },
    { prop: "titleClassName", type: "string", required: false, defaultValue: '""', description: "Custom classes for the title." },
    { prop: "count", type: "number", defaultValue: "200", description: "Sets the number of balls in the ballpit.", required: false },
    { prop: "gravity", type: "number", defaultValue: "0.5", description: "Controls the gravity affecting the balls.", required: false },
    { prop: "friction", type: "number", defaultValue: "0.9975", description: "Sets the friction applied to the ball movement.", required: false },
    { prop: "wallBounce", type: "number", defaultValue: "0.95", description: "Determines how much balls bounce off walls.", required: false },
    { prop: "followCursor", type: "boolean", defaultValue: "true", description: "Enables or disables the sphere following the cursor.", required: false },
    { prop: "colors", type: "array", defaultValue: "[0, 0, 0]", description: "Defines the colors of the balls.", required: false },
    { prop: "ambientColor", type: "number", defaultValue: "16777215", description: "Sets the ambient light color.", required: false },
    { prop: "ambientIntensity", type: "number", defaultValue: "1", description: "Controls the intensity of ambient light.", required: false },
    { prop: "lightIntensity", type: "number", defaultValue: "200", description: "Sets the intensity of the main light source.", required: false },
    { prop: "minSize", type: "number", defaultValue: "0.5", description: "Specifies the minimum size of the balls.", required: false },
    { prop: "maxSize", type: "number", defaultValue: "1", description: "Specifies the maximum size of the balls.", required: false },
    { prop: "size0", type: "number", defaultValue: "1", description: "Initial size value for the cursor ball.", required: false },
    { prop: "maxVelocity", type: "number", defaultValue: "0.15", description: "Limits the maximum velocity of the balls.", required: false },
    { prop: "maxX", type: "number", defaultValue: "5", description: "Defines the maximum X-coordinate boundary.", required: false },
    { prop: "maxY", type: "number", defaultValue: "5", description: "Defines the maximum Y-coordinate boundary.", required: false },
    { prop: "maxZ", type: "number", defaultValue: "2", description: "Defines the maximum Z-coordinate boundary.", required: false },
];

const ballpitCode = `import Ballpit from './Ballpit'; // Assuming component is in a separate file
...
const Ballpit: React.FC<BallpitProps> = ({
  ...
  return (
    <div className={cn("relative flex h-full w-full items-center justify-center overflow-hidden rounded-lg bg-black", className)}>
        {title && <h2 className={cn("select-none z-10 font-bold text-8xl", titleClassName)}>{title}</h2>}
