    ...
    <section className="mx-auto flex max-w-4xl flex-col gap-10 px-6 py-20 text-slate-200 sm:py-28">
            ...
            <header className="text-center sm:text-left">
                <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl">
                    {t('About Us')} — <span className="bg-gradient-to-r from-purple-400 to-fuchsia-300 bg-clip-text text-transparent">{t('crafting sharing code')}</span>
                </h1>
                <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed sm:mt-6 sm:text-xl">
                     {t('We’re a small band of')}{' '}<span className="font-semibold text-white">{t('full-stack professionals')}</span>{' '}{t(`who live and breathe the web — 
                    from slick interfaces to rock-solid backends`)}. Flowscape {t('is our playground for giving those learnings back to the community')}
                </p>
            </header>
            ...
            <div className="rounded-lg bg-white/5 p-6 ring-1 ring-white/10">
                <p className="mb-4 text-base font-semibold text-white sm:text-lg">{t('How we work')}</p>
                <ol className="space-y-3 text-sm leading-relaxed sm:text-base">
                    <li className="flex items-baseline gap-2">
                        ...
                        <strong className="text-white">{t('Open by default')}.</strong>{' '}{t('Components on this site are free — fork, remix, enjoy')}.
                    </li>
                    <li className="flex items-baseline gap-2">
                        <span className="rounded bg-purple-500 px-2 py-0.5 text-xs font-semibold text-black">2</span>
                        <strong className="text-white">{t('Client work ≠ black box')}.</strong>{' '}{t('We share patterns we polish in real projects')}.
                    </li>
                    <li className="flex items-baseline gap-2">
                        <span className="rounded bg-purple-500 px-2 py-0.5 text-xs font-semibold text-black">3</span>
                        <strong className="text-white">{t('Grow together')}.</strong>{' '}{t('Blog posts, livestreams, and community calls keep everyone levelling up')}.
                    </li>
                </ol>
            </div>
            ...
            <div className="rounded-lg bg-fuchsia-500/10 p-6 ring-1 ring-fuchsia-500/30 text-center sm:text-left">
                <p className="mb-2 text-base font-semibold text-fuchsia-300 sm:text-lg">{t('Need a battle-tested crew')}?</p>
                <p className="text-sm leading-relaxed sm:text-base">
                    {t('Browse our free components — or')}{' '}
                    <Link to="/pricing" className="font-semibold underline hover:text-white">{t('hire us via Pricing')}</Link>{' '}
