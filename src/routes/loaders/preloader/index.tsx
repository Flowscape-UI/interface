...
const rows: PropsTableRow[] = [
    ...
    },
    {
        ...
        required: false,
        defaultValue: '""',
        description: 'Additional CSS classes for the preloader',
    },
    {
        prop: 'color1',
        type: 'string',
            ...
            <div className="w-full px-6 py-16">
                ...
                <div className="mt-8 flex flex-col gap-10">
                    <PreviewTabs
                        ...
                        codeSandboxUrl="https://codepen.io/rikhnovets/pen/xxymqJg"
                    >
                ...
                <UsageSection
                    ...
                    description={t(
                        'A highly customizable preloader with three spinning rings. The component supports full-screen mode and can be easily integrated into any part of your application.',
                    )}
                    code={componentCode}
                />
                ...
                <DocsSection
                    description={
                        <>
                            <p className="mb-4">
                                <strong>Preloader</strong> &mdash;{' '}
                                {t(
                                    'A versatile loading indicator featuring three concentric spinning rings with independent animation speeds. Perfect for full-page loading states or inline loading indicators.',
                                )}
                            </p>
                            <p className="mb-4">
                                {t(
