        ...
        <section className="mx-auto flex max-w-4xl flex-col gap-10 px-6 py-20 text-slate-200 sm:py-28">
            ...
            <header className="text-center sm:text-left">
                <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl">
                    Installation — <span className="bg-gradient-to-r from-sky-400 to-cyan-300 bg-clip-text text-transparent">zero-setup today</span>
                </h1>
                <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed sm:mt-6 sm:text-xl">
                    Right now&nbsp;
                    <span className="font-semibold text-white">you don’t need to install anything</span>. <br className="hidden sm:inline" />
                    Find a component, copy the snippet, paste it into your React&nbsp;+&nbsp;Tailwind project — that’s it.
                </p>
            </header>
            ...
            <ul className="grid gap-6 sm:grid-cols-2">
                <li className="flex items-start gap-3 rounded-lg bg-white/5 p-4 ring-1 ring-white/10">
                    ...
                    <div className="text-sm leading-relaxed">
                        Built for <span className="font-semibold text-white">React&nbsp;18, Tailwind&nbsp;CSS&nbsp;v3+</span> &amp; <span className="font-semibold text-white">Framer&nbsp;Motion</span> — modern stack, instant familiarity.
                    </div>
                </li>
                <li className="flex items-start gap-3 rounded-lg bg-white/5 p-4 ring-1 ring-white/10">
                    ...
                    <div className="text-sm leading-relaxed">
                        <span className="font-semibold text-white">Zero-config integration.</span> Copy, paste, ship — no build-time plugins or custom loaders.
                    </div>
                </li>
                <li className="flex items-start gap-3 rounded-lg bg-white/5 p-4 ring-1 ring-white/10">
                    ...
                    <div className="text-sm leading-relaxed">
                        Inspired by&nbsp;
                        <Link href="https://ui.shadcn.com" target="_blank" className="font-semibold underline hover:text-white">
                            shadcn/ui
                        </Link>
                ...
                <li className="flex items-start gap-3 rounded-lg bg-white/5 p-4 ring-1 ring-white/10">
                    ...
                    <div className="text-sm leading-relaxed">
                        <span className="font-semibold text-white">Drop-in friendly.</span> Fully typed, theme-aware and easy to extend with your own flavors.
                    </div>
                </li>
            </ul>
            ...
            <div className="rounded-lg bg-white/5 p-6 ring-1 ring-white/10">
                ...
                <ol className="space-y-3 text-sm leading-relaxed sm:text-base">
                    ...
                    <li className="flex items-baseline gap-2">
                        ...
                        Paste it into your project — Tailwind &amp; Framer Motion are probably already there.
                    </li>
                    <li className="flex items-baseline gap-2">
            ...
            <div className="rounded-lg bg-yellow-500/10 p-6 ring-1 ring-yellow-500/30">
                <p className="mb-2 text-base font-semibold text-yellow-300 sm:text-lg">What’s next?</p>
                <p className="text-sm leading-relaxed sm:text-base">
                    We’re working on an <span className="font-semibold text-white">npm&nbsp;package</span> so you can <code>npm&nbsp;install&nbsp;flowscape</code> and pick only the pieces you need.
                    &nbsp;Expect&nbsp;tree-shakable ESM bundles, shadcn-style extraction and CLI scaffolding for lightning-fast DX.
                </p>
            </div>
        </section>
    );
