    ...
    return (
        <div className="px-6 py-16">
            ...
            <p className="text-white/60">
                Buttons are used to trigger actions or events. They can be styled in
                different ways to indicate their purpose. This page showcases various
                button styles and their usage.
            </p>
            ...
            <div className="flex flex-col gap-5 mt-8">
                ...
                <PreviewTabs title="Default Button with `isLoading` props" codeText={buttonCode}>
